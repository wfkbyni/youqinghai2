...
#import "VOAlbumsViewController.h"
#import <Photos/Photos.h>

// Views
#import "VOAlbumCell.h"
...
@interface VOAlbumsViewController () <PHPhotoLibraryChangeObserver>
...
@implementation VOAlbumsViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.title = NSLocalizedStringFromTableInBundle(@"albums.title", @"VOImagePicker", self.imagePickerController.assetBundle, nil);
...
{
    VOAssetsViewController *assetsViewController = segue.destinationViewController;
...
{
    if ([self.imagePickerController.delegate respondsToSelector:@selector(vo_imagePickerControllerDidCancel:)]) {
        [self.imagePickerController.delegate vo_imagePickerControllerDidCancel:self.imagePickerController];
    }
}
...
{
    VOAlbumCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AlbumCell" forIndexPath:indexPath];
